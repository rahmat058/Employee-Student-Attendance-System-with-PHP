   ...
   class Student{
   	...
   	public function insertStudent($name, $roll){
   		...
   		if (empty($name) || empty($roll)) {
   			...
   			if ($stu_insert) {
   				$msg = "<div class='alert alert-success'><strong>Success ! </strong>Inserted Data Successfully...</div>";
   			    return $msg;
   			}else{
   				$msg = "<div class='alert alert-danger'><strong>Error ! </strong>Data is not inserted...</div>";
   			    return $msg;
   			}
   		}
   	}
   	...
   	public function insertAttendance($cur_date, $attend = array()){
   		...
   		if ($data_insert) {
   				$msg = "<div class='alert alert-success'><strong>Success ! </strong>Attendance Data Successfully...</div>";
   			    return $msg;
   			}else{
   				$msg = "<div class='alert alert-danger'><strong>Error ! </strong>Attendance is already taken today...</div>";
   			    return $msg;
   			}
   	}
   	...
   	public function updateAttendance($dt, $attend){
   		...
   		if ($data_update) {
   				...
   				$msg = "<div class='alert alert-danger'><strong>Error ! </strong>Attendance is Not Updated ...</div>";
   			    return $msg;
   			}
   	}
